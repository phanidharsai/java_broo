...
public class SetMatrixZero {
    ...
    public static void main(String[] args){
        ...
        initial.add(new ArrayList<>(Arrays.asList(1,1,1,1)));
        initial.add(new ArrayList<>(Arrays.asList(1,0,1,1)));
        initial.add(new ArrayList<>(Arrays.asList(1,1,0,1)));
        initial.add(new ArrayList<>(Arrays.asList(0,1,1,1)));
